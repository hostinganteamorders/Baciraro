...
export const projectImages = {
  hero: `${IMAGE_BASE}/01_Hero_Mataluntung_Collection.jpg`,
  ganciDetail: `${IMAGE_BASE}/02_Ganci_Mataluntung_Detail.jpg`,
  ganciCollection: `${IMAGE_BASE}/03_Ganci_Mataluntung_Collection.jpg`,
  coasterBlueStack: `${IMAGE_BASE}/04_Coaster_Blue_Stack.jpg`,
  coasterOrange: `${IMAGE_BASE}/05_Coaster_Orange_Material.jpg`,
  ashtrayCollection: `${IMAGE_BASE}/06_Ashtray_Collection_Color_Forms.jpg`,
  ashtraySquare: `${IMAGE_BASE}/07_Ashtray_Square_Detail.jpg`,
  coasterInUse: `${IMAGE_BASE}/08_Coaster_In_Use.jpg`,
  coffeeContext: `${IMAGE_BASE}/09_Mataluntung_Coffee_Context.jpg`,
  threeObjectsLifestyle: `${IMAGE_BASE}/10_Three_Objects_Lifestyle.jpg`,
  projectHandover: `${IMAGE_BASE}/11_Project_Handover.jpg`,
  swatchDarkBlue: `${IMAGE_BASE}/Material_Dark_Blue.jpg`,
  swatchBlue: `${IMAGE_BASE}/Material_Blue.jpg`,
  swatchMixed: `${IMAGE_BASE}/Material_Mixed.jpg`,
  swatchBrown: `${IMAGE_BASE}/Material_Brown.jpg`,
  swatchGold: `${IMAGE_BASE}/Material_Gold.jpg`,
  swatchGreen: `${IMAGE_BASE}/Material_Green.jpg`,
  swatchRed: `${IMAGE_BASE}/Material_Red.jpg`,
  swatchOrange: `${IMAGE_BASE}/Material_Orange.jpg`,
  swatchPink: `${IMAGE_BASE}/Material_Pink.jpg`,
  swatchWhite: `${IMAGE_BASE}/Material_White.jpg`,
};
